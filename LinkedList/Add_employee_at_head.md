# C Program to Add an Employee Node at the Beginning of a Linked List
...
// Function to insert employee at the beginning
struct Employee* insertEmployeeBeginning(struct Employee *head, int id, char name[], float salary) {
...
int main() {
    ...
    for (int i = 0; i < n; i++) {
        ...
        head = insertEmployeeBeginning(head, id, name, salary);
    }
