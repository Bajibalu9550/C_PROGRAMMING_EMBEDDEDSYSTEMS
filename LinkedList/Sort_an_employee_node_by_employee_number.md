# C Program to Sort Employee Nodes by Employee Number in a Linked List
...
struct Employee* sortByEmployeeNumber(struct Employee *head) {
...
int main() {
    ...
    printf("\nEmployee List After Sorting by Employee Number:\n");
    displayEmployees(head);
